...
### 窗格渲染器
- 职责: 挂载窗格、双区绘制、独立滚动、卡片激活跳转、桌面折叠、移动端抽屉、轮内状态订阅生命周期、加载状态模型与渐进呈现、真实布局参与（实现 R-01-004、R-01-005、R-01-006、R-01-007、R-01-008、R-01-009、R-01-010、R-01-011、R-01-012、R-01-013、R-01-014、R-02-002、R-02-004）
- 关键内部结构:
