...
- [x] **Recent session list**: the pane is split into "Active sessions" and "Recent history" areas; inactive main sessions are shown in activity-time batches, and a "Load more sessions" button at the bottom lets users explicitly reveal older sessions.
